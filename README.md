...
3.  **Download the Dataset:**
    This project uses the [Forest Fire Classifier Dataset](https://www.kaggle.com/datasets/azimjaan21/fire-and-smoke-dataset-object-detection-yolo). Download the dataset and structure it as follows:
    ```
    .
    ├── data/
